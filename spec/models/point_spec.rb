...
RSpec.describe Point, type: :model do
  ...
  let!(:local_point) {LocalPoint.create(order_transaction: order_transaction, user: user) }
  let!(:international_point) {InternationalPoint.create(order_transaction: order_transaction_2, user: user) }
